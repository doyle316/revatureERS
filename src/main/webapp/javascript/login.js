...
function allowSearch() {
	$("#myInput").on("keyup",function() {
		...
		$("#reimbursement tr").filter(function() {
...
function displayHome(){
	document.getElementById('voldemort').innerHTML = `<input class="form-control" id="myInput" type="text" placeholder="Search....">`;
...
function displayNewReimbForm() {
	let BB = document.getElementById('blingbling');
	document.title  = 'New Reimbursement';
	BB.innerHTML = ``;
